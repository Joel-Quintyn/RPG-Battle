...
player2 = Person("Crank", 4160, 188, 311, 34, player_spells, player_items)
player3 = Person("Ramon", 3089, 174, 288, 34, player_spells, player_items)
...
while running:
    ...
    for player in players:
        ...
        if choice == 0:
            ...
            if magic_choice == -1:
                # NOTE: Makes current player misses turn
                continue
            ...
            if item.type == "potion":
                ...
                if item.name == "MegaElixer":
                    for i in players:
                        i.hp = i.maxhp
                        i.mp = i.maxmp
                    print(bcolors.OKGREEN + "\n" + item.name + " fully restores all players HP/MP" + bcolors.ENDC)
                else:
